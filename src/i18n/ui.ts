...
const en = {
  ...
  projects: {
    ...
    detail: {
      ...
      privacy: "Privacy",
      limitations: "Before You Interpret the Results",
...
const fa: typeof en = {
  ...
  projects: {
    ...
    detail: {
      ...
      overview: "مرور کلی",
      whyBuilt: "چرا این ابزار را ساختم؟",
      keyHighlights: "نکات کلیدی",
      keyFeatures: "قابلیت‌های اصلی",
      ...
      version: "نسخه",
      screenshots: "تصاویر",
      howToUse: "چطور استفاده کنم؟",
      installNote: "یادداشت نصب",
      privacy: "حریم خصوصی",
      limitations: "پیش از تفسیر نتیجه",
      roleImplementation: "نقش و پیاده‌سازی",
      faq: "پرسش‌های متداول",
