         ...
         <AnimatePresence>
            ...
            >
               ...
               <motion.div
                  ...
                  className="relative bg-action rounded-3xl shadow-2xl p-10 max-w-md w-full mx-6 overflow-hidden border border-secondary pointer-events-auto"
               >
                  ...
                  <div className="relative z-10 text-center">
                     ...
                     <motion.button
                        ...
                        className="px-8 py-3 bg-secondary text-action rounded-full font-medium hover:shadow-xl transition pointer-events-auto"
                     >
                        Close
                     </motion.button>
                  </div>
