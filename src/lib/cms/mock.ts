  ...
  experience: [
    {
      ...
      period: "2023 — Present",
      summary: "Owning frontend architecture for data-intensive dashboards and real-time interfaces.",
      points: [
        "Optimized heavy data dashboards handling 2M+ data points",
        "Implemented Web Workers to keep the main thread responsive",
        "Established reusable component and state architecture",
        "Improved average interaction performance by ~40%",
      ],
    },
    {
      role: "CTO",
      company: "Hooshex",
      period: "2022 — 2023",
      summary: "Led technical direction, architecture, and delivery across web and cross-platform products.",
      points: [
        "Defined engineering standards and cross-platform architecture",
        "Coordinated a small team and set the performance strategy",
        "Drove product-level frontend decisions end to end",
        "Balanced hands-on engineering with technical leadership",
      ],
    },
    {
      ...
      period: "2021 — 2022",
      summary: "Shipped client-facing features and led a major framework migration.",
      points: [
        "Migrated the platform from Vue 2 to Vue 3",
        "Delivered real-time features and responsive interfaces",
        "Boosted client-side performance by ~30%",
        "Supported clients directly, closing the loop on issues fast",
      ],
    },
    {
      ...
      period: "2020 — 2021",
      summary: "Built the fundamentals: clean components, solid CSS, and dependable delivery.",
      points: [
        "Implemented responsive, accessible UI components",
        "Learned production workflows and code review discipline",
        "Contributed to internal tooling and small features",
      ],
    },
  ],
  achievements: [
    ...
    },
    {
      ...
      body: "Operated at CTO level — setting standards, coordinating delivery, and owning architecture decisions.",
    },
    {
  ...
  experience: [
    {
      ...
      period: "۲۰۲۳ — اکنون",
      summary: "مالکیت معماریِ فرانت‌اند برای داشبوردهای داده‌محور و رابط‌های Real-time.",
      points: [
        "بهینه‌سازی داشبوردهای داده‌ی سنگین با بیش از ۲ میلیون نقطه‌داده",
        "به‌کارگیری Web Workers برای حفظ واکنش‌گراییِ ترد اصلی",
        "استقرار معماریِ کامپوننت و state قابل‌استفاده‌ی مجدد",
        "بهبود میانگین عملکرد تعامل تا حدود ۴۰٪",
      ],
    },
    {
      role: "CTO",
      company: "Hooshex",
      period: "۲۰۲۲ — ۲۰۲۳",
      summary: "هدایت جهت‌گیریِ فنی، معماری و تحویل در محصولات وب و کراس‌پلتفرم.",
      points: [
        "تعریف استانداردهای مهندسی و معماریِ کراس‌پلتفرم",
        "هماهنگیِ یک تیم کوچک و تعیین استراتژی عملکرد",
        "هدایت تصمیم‌های فرانت‌اند در سطح محصول به‌صورت سرتاسری",
        "ایجاد توازن میان مهندسیِ عملی و رهبریِ فنی",
      ],
    },
    {
      ...
      company: "Site Saz Portal",
      period: "۲۰۲۱ — ۲۰۲۲",
      summary: "ارائه‌ی قابلیت‌های سمت کاربر و هدایت یک مهاجرت بزرگِ فریم‌ورک.",
      points: [
        "مهاجرت پلتفرم از Vue 2 به Vue 3",
        "ارائه‌ی قابلیت‌های Real-time و رابط‌های واکنش‌گرا",
        "افزایش عملکرد سمت کلاینت تا حدود ۳۰٪",
        "پشتیبانی مستقیم از مشتریان و رفع سریع مشکلات",
      ],
    },
    {
      ...
      company: "Shahan Gold Company",
      period: "۲۰۲۰ — ۲۰۲۱",
      summary: "ساخت پایه‌ها: کامپوننت‌های تمیز، CSS محکم و تحویل قابل‌اتکا.",
      points: [
        "پیاده‌سازی کامپوننت‌های UI واکنش‌گرا و دسترس‌پذیر",
        "یادگیری جریان‌های کاریِ تولید و نظم بازبینی کد",
        "مشارکت در ابزارهای داخلی و قابلیت‌های کوچک",
      ],
    },
  ],
  achievements: [
    ...
    {
      title: "رهبری فنی",
      body: "فعالیت در سطح CTO — تعیین استانداردها، هماهنگی تحویل و مالکیت تصمیم‌های معماری.",
    },
    {
